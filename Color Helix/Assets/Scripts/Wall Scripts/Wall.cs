...
public class Wall : MonoBehaviour
{
    ...
    void SpawnWallFragemnts()
    {
        ...
        wall2.GetComponent<BoxCollider>().size = new Vector3(0.9f, 2f, 0.2f);
        wall2.GetComponent<BoxCollider>().center = new Vector3(0.46f, 0, 7);
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            else
            {
                ...
                wall2.GetComponent<BoxCollider>().center = new Vector3(0.46f, 0, WallF.transform.position.z);
            }
        }
