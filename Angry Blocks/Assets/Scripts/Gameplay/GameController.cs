...
public class GameController : MonoBehaviour
{
    ...
    void Awake()
    {
        shotCountText = GameObject.Find("ShotCount").GetComponent<ShotCountText>();
        ballsCountText = GameObject.Find("BallCountText").GetComponent<Text>();
        BallsContainer = GameObject.Find("Balls Container");
    }
    ...
    void SpawnNewLevel(int numberLevel1, int numberLevel2 , int min ,int max)
    {
        ...
        level1Pos = new Vector2(6f, 1);
        level2Pos = new Vector2(6f, -3.4f);
